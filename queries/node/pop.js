  ...
  app.db.oneOrNone(`
    ...
    .then(pop => [
      // tpop folder
      {
        ...
        expanded: false,
        children: [0],
        path: [`Projekte`, pop.ProjId, `Arten`, pop.ApArtId, `Populationen`, pop.PopId, `Teil-Populationen`],
      },
      // popber folder
      {
        ...
        expanded: false,
        children: [0],
        path: [`Projekte`, pop.ProjId, `Arten`, pop.ApArtId, `Populationen`, pop.PopId, `Kontroll-Berichte`],
      },
      // popmassnber folder
      {
        ...
        expanded: false,
        children: [0],
        path: [`Projekte`, pop.ProjId, `Arten`, pop.ApArtId, `Populationen`, pop.PopId, `Massnahmen-Berichte`],
      },
    ])
