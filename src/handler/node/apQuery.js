  ...
  return app.db.task(function* getData() {
    ...
    return [
      ...
      // erfkrit folder
      {
        ...
        table: `ap`,
        id: apArtId,
        label: `AP-Erfolgskriterien (${ap.AnzErfkrit})`,
        expanded: false,
      ...
      // beobNichtBeurteilt folder
      {
        ...
        table: `ap`,
        id: apArtId,
        label: `nicht beurteilte Beobachtungen (${ap.AnzBeobNichtBeurteilt < 100 ? ap.AnzBeobNichtBeurteilt : `neuste 100 von ${ap.AnzBeobNichtBeurteilt}`})`,
        expanded: false,
      ...
      // beobNichtZuzuordnen folder
      {
        ...
        table: `ap`,
        id: apArtId,
        label: `nicht zuzuordnende Beobachtungen (${ap.AnzBeobNichtZuzuordnen < 100 ? ap.AnzBeobNichtZuzuordnen : `neuste 100 von ${ap.AnzBeobNichtZuzuordnen}`})`,
        expanded: false,
      ...
      // assozarten folder
      {
        ...
        table: `ap`,
        id: apArtId,
        label: `assoziierte Arten (${ap.AnzAssozart})`,
        expanded: false,
