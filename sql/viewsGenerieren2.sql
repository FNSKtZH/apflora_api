...
ORDER BY
	apflora_beob.adb_eigenschaften.Artname, apflora.pop.PopNr, apflora_views.v_pop_berundmassnjahre.Jahr;
...
ORDER BY
	apflora_beob.adb_eigenschaften.Artname, apflora.pop.PopNr, apflora.tpop.TPopNr, apflora_views.v_tpop_berjahrundmassnjahr.Jahr;
