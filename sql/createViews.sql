...
DROP VIEW IF EXISTS views.v_massn_fuergis CASCADE;
CREATE OR REPLACE VIEW views.v_massn_fuergis AS
SELECT
  beob.adb_eigenschaften."TaxonomieId" AS "ApArtId",
...
DROP VIEW IF EXISTS views.v_pop_fuergis CASCADE;
CREATE OR REPLACE VIEW views.v_pop_fuergis AS
SELECT
  beob.adb_eigenschaften."TaxonomieId" AS "ApArtId",
  beob.adb_eigenschaften."Artname" AS "AP Art",
  apflora.ap_bearbstand_werte."DomainTxt" AS "AP Status",
...
DROP VIEW IF EXISTS views.v_tpop_fuergis CASCADE;
CREATE OR REPLACE VIEW views.v_tpop_fuergis AS
SELECT
  beob.adb_eigenschaften."TaxonomieId" AS "ApArtId",
  beob.adb_eigenschaften."Artname" AS "AP Art",
  apflora.ap_bearbstand_werte."DomainTxt" AS "AP Status",
...
DROP VIEW IF EXISTS views.v_tpopkontr_fuergis CASCADE;
CREATE OR REPLACE VIEW views.v_tpopkontr_fuergis AS
SELECT
  apflora.ap."ApArtId",
